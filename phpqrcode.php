 ...
 */
    ...
    class QRimage {
        ...
        //----------------------------------------------------------------------
        public static function png($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4,$saveandprint=FALSE, $back_color, $fore_color, $qr_width = '', $qr_height = '', $qr_transparency = false)
        { 
            $image = self::image($frame, $pixelPerPoint, $outerFrame, $back_color, $fore_color, $qr_width, $qr_height, $qr_transparency);
        ...
        //----------------------------------------------------------------------
        private static function image($frame, $pixelPerPoint = 4, $outerFrame = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000, $qr_width = '', $qr_height = '', $qr_transparency = false)
        {
            $h = count($frame);
            $w = strlen($frame[0]);
            ...
            $targetW = (!empty($qr_width) ? $qr_width : $imgW * $pixelPerPoint );
            $targetH = (!empty($qr_height) ? $qr_height : $imgH * $pixelPerPoint );
       
            $target_image =ImageCreate($targetW, $targetH);
   
            ImageCopyResized($target_image, $base_image, 0, 0, 0, 0, $targetW, $targetH, $imgW, $imgH);
            if ( $qr_transparency ) imagecolortransparent($target_image, $col[0]);
 ...
 */
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public static function png($text, $outfile = false, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint=false, $back_color = 0xFFFFFF, $fore_color = 0x000000, $qr_width = '', $qr_height = '', $qr_transparency = false) 
        { 
            $enc = QRencode::factory($level, $size, $margin, $back_color, $fore_color, false, $qr_width, $qr_height, $qr_transparency);
    ...
    class QRencode {
        ...
        //----------------------------------------------------------------------
        public static function factory($level = QR_ECLEVEL_L, $size = 3, $margin = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000, $cmyk = false, $qr_width = '', $qr_height = '', $qr_transparency = false)
        {
            $enc = new QRencode();
            $enc->size = $size;
            $enc->margin = $margin;
            ...
            $enc->qr_width = $qr_width;
            $enc->qr_height = $qr_height;
            $enc->qr_transparency = $qr_transparency;
        ...
        public function encodePNG($intext, $outfile = false,$saveandprint=false) 
        {
            try {
                ...
                QRimage::png($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin,$saveandprint, $this->back_color, $this->fore_color, $this->qr_width, $this->qr_height, $this->qr_transparency);
